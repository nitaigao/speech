...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 9, 16, sizeof(::google::api::MonitoredResource_LabelsEntry_DoNotUse)},
  { 18, -1, sizeof(::google::api::MonitoredResource)},
};
...
MonitoredResourceDescriptor* MonitoredResourceDescriptor::New(::google::protobuf::Arena* arena) const {
  MonitoredResourceDescriptor* n = new MonitoredResourceDescriptor;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
MonitoredResource* MonitoredResource::New(::google::protobuf::Arena* arena) const {
  MonitoredResource* n = new MonitoredResource;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
