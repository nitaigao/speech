...
class Operations final {
 public:
  ...
  typedef WithStreamedUnaryMethod_GetOperation<WithStreamedUnaryMethod_ListOperations<WithStreamedUnaryMethod_CancelOperation<WithStreamedUnaryMethod_DeleteOperation<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetOperation<WithStreamedUnaryMethod_ListOperations<WithStreamedUnaryMethod_CancelOperation<WithStreamedUnaryMethod_DeleteOperation<Service > > > > StreamedService;
};
